...
CODES = {
    ...
    u"Multimedia": u"MR",
    u"Consortium": u"CR",
    u"Consortium": u"Silverchair:CR_TR_J1", ## almeida
}
...
REPORT_DESCRIPTIONS = {
    ...
    u"Silverchair:CR_TR_J1": u'Silverchair Consortium Journal Requests (Excluding "OA_Gold")',
}
...
HEADER_FIELDS = {
    ...
    "TR_J1": (
        ...
        u"Metric_Type",
        u"Reporting Period Total",
        #u"Reporting Period HTML", #Almeida - Comentei para ver se essas duas colunas não apareciam mais no relatório.
        #u"Reporting Period PDF",
    ),
    "CR_TR_J1": ( ## almeida
        u"Istitution_Name",
